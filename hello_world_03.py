...
def main():
    ...
    conn = sqlite3.connect("sparkify.db")
    cur = conn.cursor()

    process_data(cur, conn, filepath='song_data/A', func=process_song_file)
    process_data(cur, conn, filepath='log_data/2018/11', func=process_log_file)
